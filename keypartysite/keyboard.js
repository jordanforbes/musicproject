...
var listOfScaleTypes = ["Ionian","Dorian","Phrygian","Lydian","Mixolydian","Aeolian","Locrian","Dim","Maj Pent","Min Pent","Blues"]
var noteFreq=[]
var arrayOfNotes=[]
var time = .15
	    ...
	    setTimeout(function() {
	     ...
	     setTimeout(function() {
	      ...
	      setTimeout(function() {
			...
			color[8] = $(".abs"+(varArrParam[0]+12)).css("background-color");
	      ...
	      setTimeout(function() {
			...
			$(".abs"+(varArrParam[0]+12)).css("background-color",color[8]);
